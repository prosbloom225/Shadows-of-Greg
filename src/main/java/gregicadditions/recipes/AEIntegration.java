...
public class AEIntegration {
    ...
    public static void init() {
        ...
        // Recipe removal
        if (GAConfig.Misc.recipeRemoval) {
        ...
        if (GAConfig.Misc.formingProcessorsPrintRecipes) {
        ...
        if (GAConfig.Misc.processorAssemblerRecipes) {
        ...
        ModHandler.addShapelessRecipe("ga:fluix_dust", materials.fluixDust().maybeStack(1).get(), materials.fluixCrystal().maybeStack(1).get(), ToolDictNames.craftingToolHardHammer);
    }
}
